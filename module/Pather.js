(function (factory, window) {
    ...
    // define a Common JS module that relies on 'leaflet'
        ...
        var d3 = require('d3');
        module.exports = factory(leaflet, d3);
    }

    // attach your plugin to the global 'L' variable
    if (typeof window !== 'undefined' && window.L && window.d3) {
        window.L.Pather = factory(window.L, window.d3);
        window.L.pather = function (options) {
        	return new window.L.Pather(options);
        };
    }
}(function (L, d3) {
    ...
    if (typeof d3 === 'undefined') {
        ...
        // Ensure d3.js has been included before Pather.
        throwException('d3 is required http://d3js.org/');
     ...
     * @link https://github.com/Wildhoney/Pather
     */
    var Pather = L.FeatureGroup.extend({
         ...
         * @return {Pather.Polyline|Boolean}
         */
        createPath: function createPath(latLngs) {
            ...
            var polyline = new Pather.Polyline(this.map, latLngs, this.options, {
        ...
        /**
         * @method removePath
         * @param {Pather.Polyline} model
         * @return {Boolean}
         */
        removePath: function removePath(model) {
    
            if (model instanceof Pather.Polyline) {
